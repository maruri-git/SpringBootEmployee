...
public class EmployeeControllerTest {
    ...
    void should_return_employees_when_get_given_employees() throws Exception {
        //given*/
        employeeService.save(new Employee(1, "Marcelo", 20, "Male", 20000));
        employeeService.save(new Employee(2, "Maria", 30, "Female", 999999));
        //when then
...
//        employeeRepository.add(new Employee("Marcelo", 20, "Male", 20000));
        Employee employee = employeeService.save(new Employee(2, "Maria", 30, "Female", 999999));
        //when then
    ...
    void should_return_by_gender_when_get_given_employees() throws Exception {
        ...
        employeeService.save(new Employee(1, "Marcelo", 20, "Male", 20000));
        employeeService.save(new Employee(2, "Maria", 30, "Female", 999999));
        employeeService.save(new Employee(3, "Elijah", 25, "Male", 99999));
        employeeService.save(new Employee(4, "Jepster", 22, "Male", 20000));
        //when
    ...
    void should_update_when_put_given_employee_and_updated_employee() throws Exception {
        //given
        Employee employee = employeeService.save(new Employee(1, "Marcelo", 20, "Male", 1)); // remove add employee
    ...
    void should_delete_when_delete_given_id() throws Exception {
        //given
        Employee createdEmployee = employeeService.save(new Employee(1, "Marcelo", 20, "Male", 1));
        //when
